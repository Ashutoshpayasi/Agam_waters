...
<!-- Mirrored from azim.commonsupport.com/Acuasafe/faq.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Feb 2024 07:29:51 GMT -->
<head>
<meta charset="utf-8">
                            ...
                            <ul class="accordion-box">
                                <li class="accordion block active-block">
                                    ...
                                    <div class="acc-content current">
                                        <div class="text">
                                            <p>Lorem ipsum dolor sit amet consectur adip icing sed do eiusmod tempor incididunt labore dolore magna aliqua enim ad minim veniam. quis nostrud exercitation amco laboris nisi ut aliquip ex ea commodo consequat Duis aute irure dolor in reprehen derit in voluptate velit esse cillum.</p>
                                ...
                                <li class="accordion block">
                                     <div class="acc-btn">
                                        <div class="icon-outer"><i class="fal fa-plus"></i></div>
                                        <h4>What is the best way to contact with the delivery man?</h4>
                                    </div>
                                    <div class="acc-content">
                                        <div class="text">
                                            <p>Lorem ipsum dolor sit amet consectur adip icing sed do eiusmod tempor incididunt labore dolore magna aliqua enim ad minim veniam. quis nostrud exercitation amco laboris nisi ut aliquip ex ea commodo consequat Duis aute irure dolor in reprehen derit in voluptate velit esse cillum.</p>
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 sidebar-column">
                        <div class="faq-sidebar">
                            <div class="form-inner">
                                ...
                                <form action="https://azim.commonsupport.com/Acuasafe/faq.php" method="post">
                                    <div class="form-group">
