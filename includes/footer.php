                    ...
                    <div class="row clearfix">
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget logo-widget">
                                <figure class="footer-logo"><a href="index-2.php"><img
                            ...
                            <div class="footer-widget contact-widget ml-70">
                                ...
                                <div class="widget-content">
                                    <ul class="info-list clearfix">
                                        ...
                                        <li><i class="fal fa-phone"></i>Call Us: <a
                                                href="tel:3336660001">333-666-0001</a></li>
                            ...
                            <div class="footer-widget subscribe-widget">
                                ...
                                <div class="widget-content">
                                    ...
                                    <div class="form-inner">
                                        <form action="https://azim.commonsupport.com/Acuasafe/contact.php"
                                            method="post">
