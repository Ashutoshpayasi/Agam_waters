...
<!-- Mirrored from azim.commonsupport.com/Acuasafe/index-3.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Feb 2024 07:29:34 GMT -->
<head>
<meta charset="utf-8">
    ...
    <div class="boxed_wrapper">
        ...
        <header class="main-header header-style-two">
            ...
            <div class="header-lower">
                <div class="outer-box">
                    <div class="logo-box">
                        <figure class="logo"><a href="index-2.php"><img src="assets/images/logo.png" alt=""></a></figure>
                    </div>
                                ...
                                <ul class="navigation clearfix">
                                    <li class="current dropdown"><a href="index-2.php">Home</a>
                                        <ul>
                                            ...
                                            <li class="dropdown"><a href="index-2.php">Header Style</a>
                                                <ul>
                                                    <li><a href="index-2.php">Header Style 01</a></li>
                                                    <li><a href="index-4.php">Header Style 02</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="dropdown"><a href="index-2.php">Pages</a>
                                        <ul>
                                            <li><a href="about.php">About Us</a></li>
                                            <li><a href="team.php">Our Team</a></li>
                                            <li><a href="testimonials.php">Testimonials</a></li>
                                            <li><a href="faq.php">Faq's</a></li>
                                            <li><a href="gallery.php">Gallery One</a></li>
                                            <li><a href="gallery-2.php">Gallery Two</a></li>
                                            <li><a href="error.php">404</a></li>
                                        </ul>
                                    </li> 
                                    <li class="dropdown"><a href="index-2.php">Services</a>
                                        <ul>
                                            <li><a href="service.php">Our Services</a></li>
                                            <li><a href="service-details.php">Project Planning</a></li>
                                            <li><a href="service-details-2.php">Residential Waters</a></li>
                                            <li><a href="service-details-3.php">Commercial Waters</a></li>
                                            <li><a href="service-details-4.php">Filtration Plants</a></li>
                                            <li><a href="service-details-5.php">Water Softening</a></li>
                                            <li><a href="service-details-6.php">Market Research</a></li>
                                        </ul>
                                    </li> 
                                    <li class="dropdown"><a href="index-2.php">Shop</a>
                                        <ul>
                                    ...
                                    <li class="dropdown"><a href="index-2.php">Elements</a>
                                        <div class="megamenu">
                                            <div class="row clearfix">
                                                <div class="col-xl-6 column">
                                                    <ul>
                                                        ...
                                                        <li><a href="feature-element-2.php">Feature Block 02</a></li>
                                                        <li><a href="about-element-1.php">About Block 01</a></li>
                                                        <li><a href="about-element-2.php">About Block 02</a></li>
                                                        <li><a href="service-element-1.php">Service Block 01</a></li>
                                                        <li><a href="service-element-2.php">Service Block 02</a></li>
                                                        <li><a href="service-element-3.php">Service Block 03</a></li>
                                                        <li><a href="service-element-4.php">Service Block 04</a></li>
                                                    </ul>
                                                </div>
                                                <div class="col-xl-6 column">
                                                    <ul>
                                                        <li><h4>Elements 2</h4></li>
                                                        <li><a href="news-element-1.php">News Block 01</a></li>
                                                        <li><a href="news-element-2.php">News Block 02</a></li>
                                                        <li><a href="team-element-1.php">Team Block 01</a></li>
                                                        <li><a href="team-element-2.php">Team Block 02</a></li>
                                                        <li><a href="cta-element-1.php">Cta Block 01</a></li>
                                                        <li><a href="cta-element-2.php">Cta Block 02</a></li>
                                                        <li><a href="pricing-element.php">Pricing Block</a></li>
                                                        <li><a href="chooseus-element.php">Chooseus Block</a></li>
                                                    </ul>
                                                </div>                                   
                                            </div>                                        
                                        </div>
                                    </li> 
                                    <li class="dropdown"><a href="index-2.php">Blog</a>
                                        <ul>
                    ...
                    <ul class="nav-right">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu search-panel" aria-labelledby="dropdownMenu3">
                                    <div class="form-container">
                                        <form method="post" action="https://azim.commonsupport.com/Acuasafe/blog.php">
                        ...
                        <li class="cart-box">
                            <a href="shop.php"><i class="fal fa-shopping-cart"></i><span>3</span></a>
                        </li>
                        <li class="btn-box">
                            <a href="index-2.php" class="theme-btn btn-one">Request A Quote</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index-2.php"><img src="assets/images/logo-2.png" alt="" title=""></a></div>
            ...
            <div class="banner-carousel owl-theme owl-carousel owl-dots-none">
                <div class="slide-item">
                    <div class="auto-container">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><img src="assets/images/banner/vector-5.png" alt=""></figure>
                            </div>
                            <div class="content-box">
                                ...
                                <div class="btn-box clearfix">
                                    ...
                                    <a href="service.php" class="theme-btn banner-btn">Discover</a>
                                </div>
                            </div>
                        </div> 
                    </div>
        ...
        <!-- feature-section -->
        <section class="feature-section light alternat-2 centred">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-3 col-md-6 col-sm-12 feature-block">
                            <div class="feature-block-one">
                                <div class="inner-box">
                                    <div class="shape" style="background-image: url(assets/images/shape/shape-27.png);"></div>
                ...
                <div class="row align-items-center clearfix">
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <div class="image_block_2">
                            <div class="image-box">
                                <figure class="image image-1 clearfix"><img src="assets/images/resource/about-2.png" alt=""></figure>
                                <figure class="image image-2"><img src="assets/images/resource/about-3.png" alt=""></figure>
                                <div class="text">
                                    <h2>20</h2>
                                    <h6>Years Of Exps</h6>
                                </div>
        ...
        <!-- shop-section -->
        <section class="shop-section centred pt-145 bg-color-1">
                        ...
                        <div class="shop-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500m">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    ...
                                    <h4><a href="shop-details.php">Mineral Water Bottle</a></h4>
                                    <h6>$70.00</h6>
                                    <p>Lorem ipsum dolor sit amet adipelit sed eiusmte.mpor encid dolore.</p>
                                    <div class="btn-box">
                                        <a href="shop-details.php" class="theme-btn btn-two">Add to cart</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="cta-section bg-color-2">
            ...
            <div class="auto-container">
                <div class="row align-items-center clearfix">
                    <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                        <figure class="image-box wow slideInLeft animated" data-wow-delay="00ms" data-wow-duration="1500m clearfix"><img src="assets/images/resource/cta-1.png" alt=""></figure>
                    </div>
                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                        <div class="content_block_3">
                            <div class="content-box">
                                ...
                                <div class="text">
                                    <p>We give our services to more than 10 countries. We give our delivery service using more than 50 couriers within 2hr in anywhere in the city.</p>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500m">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h4><a href="index-2.php">Christian Bale</a></h4>
                                    <span class="designation">CEO & Founder</span>
                                    <div class="share-box"><a href="index-2.php"><i class="fas fa-share-alt"></i></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500m">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h4><a href="index-2.php">Hard Branots</a></h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500m">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h4><a href="index-2.php">Monica Bana</a></h4>
                    ...
                    <div class="row align-items-center clearfix">
                        <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                            <div class="content-box">
                                ...
                                <div class="text">
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed eiusmod tempor incididunt ut labore et dolore magna aliqua.enim ad minim veniam quis nostrud.Exercitation ullamco laboris nisi ut aliquip ex ea commodo</p>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 inner-column">
                            <div class="inner-box">
                                <div class="inner-pattern" style="background-image: url(assets/images/shape/shape-31.png);"></div>
                                <div class="pr-content">
                                    <div class="pr-tab active-tab" id="tab-1">
                                        <div class="pricing-block-one">
                                            <div class="pricing-table">
                                                <div class="shape-layer" style="background-image: url(assets/images/shape/shape-28.png);"></div>
                                                <div class="table-header">
                                                    <div class="price-box">
                                                        <div class="price-shape">
                                                            <div class="shape-1" style="background-image: url(assets/images/shape/shape-29.png);"></div>
                                                            <div class="shape-2" style="background-image: url(assets/images/shape/shape-30.png);"></div>
                                                        </div>
                                                        <h3>$49</h3>
                                                        <span>Monthly</span>
                                                    </div>
                                                ...
                                                <div class="table-content">
                                                    <ul class="feature-list clearfix">
                                                        <li>SEO Analytics Tools</li>
                                                        <li>10 Gb Space on Cloud</li>
                                                        <li>2 Printer & Fax</li>
                                                        <li class="light">Team Access</li>
                                                        <li class="light">Privacy Settings</li>
                                                    </ul>
                                                </div>
                                                <div class="table-footer">
                                                    <a href="index-2.php" class="theme-btn btn-one">Learn More</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <section class="testimonial-style-two centred bg-color-1">
            <div class="thumb-box">
                <div class="thumb thumb-1"><img src="assets/images/resource/thumb-1.jpg" alt=""></div>
                <div class="thumb thumb-2"><img src="assets/images/resource/thumb-2.jpg" alt=""></div>
                <div class="thumb thumb-3"><img src="assets/images/resource/thumb-3.jpg" alt=""></div>
                <div class="thumb thumb-4"><img src="assets/images/resource/thumb-4.jpg" alt=""></div>
                <div class="thumb thumb-5"><img src="assets/images/resource/thumb-5.jpg" alt=""></div>
                <div class="thumb thumb-6"><img src="assets/images/resource/thumb-6.jpg" alt=""></div>
            </div>
            <div class="pattern-layer">
            ...
            <div class="map-layer" style="background-image: url(assets/images/icons/map-1.png);"></div>
            <div class="auto-container">
                <div class="sec-title">
                    <h2>What Our Client are Saying <br />About Acuasafe</h2>
                </div>
                <div class="row clearfix">
                            ...
                            <div class="testimonial-block-two">
                                <div class="inner-box">
                                    ...
                                    <div class="inner">
                                        ...
                                        <p>Lorem ipsum dolor amet consectur adicing elit sed do usmod tempor incididunt enimad minim veniam quis nostrud exer citation laboris nisi aliquip commodo perspiciatis unde omnis natus.</p>
        ...
        <section class="news-section">
            <div class="auto-container">
                <div class="sec-title centred">
                    <h2>Stay Update with <br />Acuasafe</h2>
                </div>
                <div class="row clearfix">
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500m">
                            <div class="inner-box">
                                <figure class="image-box"><a href="blog-details.php"><img src="assets/images/news/news-1.jpg" alt=""></a></figure>
                                <div class="lower-content">
                                    <div class="category"><a href="blog-details.php">Consulting</a></div>
                                    <h4><a href="blog-details.php">Consecter Elit Dui Eiusmod Didunt Labore Dolor.</a></h4>
                                    <ul class="post-info clearfix">
                                        <li><a href="blog-details.php">Nelly Farel</a></li>
                                        <li>Aug 07, 2021</li>
                                    </ul>
                                    <div class="text">
                                        <p>Lorem ipsum dolor sit amet, consecte adipisicing elit sed do eiusmod tempor incididunt labore aliqua.</p>
                                    </div>
                                    <div class="btn-box">
                                        <a href="blog-details.php" class="theme-btn btn-two">Learn More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500m">
                            <div class="inner-box">
                                <figure class="image-box"><a href="blog-details.php"><img src="assets/images/news/news-2.jpg" alt=""></a></figure>
                                <div class="lower-content">
                                    <div class="category"><a href="blog-details.php">Consulting</a></div>
                                    <h4><a href="blog-details.php">Taking The Pattern Library To The Next Level</a></h4>
                                    <ul class="post-info clearfix">
                                        <li><a href="blog-details.php">Monica Bana</a></li>
                                        <li>Aug 07, 2021</li>
                                    </ul>
                                    <div class="text">
                                        <p>Lorem ipsum dolor sit amet, consecte adipisicing elit sed do eiusmod tempor incididunt labore aliqua.</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500m">
                            <div class="inner-box">
                                <figure class="image-box"><a href="blog-details.php"><img src="assets/images/news/news-3.jpg" alt=""></a></figure>
                                <div class="lower-content">
                                    <div class="category"><a href="blog-details.php">Consulting</a></div>
                                    <h4><a href="blog-details.php">How New Font Improve The Web</a></h4>
                                    <ul class="post-info clearfix">
                                        <li><a href="blog-details.php">Hard Branots</a></li>
                                        <li>Aug 07, 2021</li>
                                    </ul>
                                    <div class="text">
                                        <p>Lorem ipsum dolor sit amet, consecte adipisicing elit sed do eiusmod tempor incididunt labore aliqua.</p>
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget logo-widget">
                                <figure class="footer-logo"><a href="index-2.php"><img src="assets/images/footer-logo.png" alt=""></a></figure>
                                <div class="text">
                            ...
                            <div class="footer-widget links-widget ml-70">
                                ...
                                <div class="widget-content">
                                    <ul class="links-list clearfix">
                                        <li><a href="index-2.php">About Company</a></li>
                                        <li><a href="index-2.php">Services</a></li>
                                        <li><a href="index-2.php">How It Works</a></li>
                                        <li><a href="index-2.php">Our Blog</a></li>
                                        <li><a href="index-2.php">Contact Us</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="footer-widget subscribe-widget">
                                ...
                                <div class="widget-content">
                                    ...
                                    <div class="form-inner">
                                        <form action="https://azim.commonsupport.com/Acuasafe/contact.php" method="post">
                                            <div class="form-group">
            ...
            <div class="footer-bottom">
                <div class="auto-container">
                    <div class="bottom-inner">
                        <div class="copyright">
                            <p><a href="index-2.php">Acuasafe</a> &copy; 2021 All Right Reserved</p>
                        </div>
                        <ul class="social-links clearfix">
                            <li><a href="index-2.php"><i class="fab fa-facebook-f"></i></a></li>
                            <li><a href="index-2.php"><i class="fab fa-twitter"></i></a></li>
                            <li><a href="index-2.php"><i class="fab fa-google-plus-g"></i></a></li>
                            <li><a href="index-2.php"><i class="fab fa-linkedin-in"></i></a></li>
                        </ul>
                        <ul class="footer-nav clearfix">
                            <li><a href="index-2.php">Terms of Service</a></li>
                            <li><a href="index-2.php">Privacy Policy</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from azim.commonsupport.com/Acuasafe/index-3.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Feb 2024 07:29:44 GMT -->
</html>
