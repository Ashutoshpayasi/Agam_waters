...
<!-- Mirrored from azim.commonsupport.com/Acuasafe/index-onepage.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Feb 2024 07:29:44 GMT -->
<head>
<meta charset="utf-8">
...
<body>
    ...
    <div class="boxed_wrapper">
                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation scroll-nav clearfix">
                                    <li class="dropdown"><a href="index-onepage.php">Home</a>
                                        <ul>
        ...
        <!-- service-section -->
        <section class="service-section bg-color-1" id="service">
        ...
        <!-- shop-section -->
        <section class="shop-section centred" id="shop">
            <div class="auto-container">
                <div class="sec-title">
        ...
        <!-- testimonial-section -->
        <section class="testimonial-section bg-color-1" id="testimonial">
            <div class="shape-layer">
