...
<!-- Mirrored from azim.commonsupport.com/Acuasafe/shop-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Feb 2024 07:30:01 GMT -->
<head>
<meta charset="utf-8">
                        ...
                        <nav class="main-menu navbar-expand-md navbar-light">
                            <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul class="navigation clearfix">
                                    ...
                                    <li class="current dropdown"><a href="index-2.php">Shop</a>
                                        <ul>
                ...
                <div class="product-details-content">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div class="image-box">
                                <figure class="image"><img src="assets/images/resource/shop/shop-9.jpg" alt=""></figure>
                                <div class="preview-link"><a href="assets/images/resource/shop/shop-9.jpg" class="lightbox-image" data-fancybox="gallery"><i class="far fa-search-plus"></i></a></div>
                            </div>
                        </div>
                            ...
                            <div class="product-details">
                                ...
                                <div class="customer-rating clearfix">
                                    ...
                                    <div class="review pull-left">
                                        <a href="shop-details.php">( 5 Reviews )</a>
                                    </div>
                                </div>
                                <h5>$90.00</h5>
                                <div class="text">
                                    <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. sed ut perspic atis unde omnis iste natus error sit voluptam accusan.</p>
                                </div>
                                <div class="addto-cart-box"> 
                                    <ul class="clearfix">
                                        <li class="item-quantity"><input class="quantity-spinner" type="text" value="1" name="quantity"></li>
                                        <li><button type="button" class="theme-btn btn-one">Add To Cart</button></li>
                                        <li><a href="shop-details.php"><i class="far fa-heart"></i></a></li>
                                        <li><a href="shop.php"><i class="far fa-search"></i></a></li>
                                    </ul>
                                </div>
                                <div class="other-option">
                                    ...
                                    <ul class="social-links clearfix">
                                        ...
                                        <li><a href="shop-details.php"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a href="shop-details.php"><i class="fab fa-twitter"></i></a></li>
                                        <li><a href="shop-details.php"><i class="fab fa-vimeo-v"></i></a></li>
                                        <li><a href="shop-details.php"><i class="fab fa-google-plus-g"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tabs-box">
                        ...
                        <div class="tabs-content">
                            <div class="tab active-tab" id="tab-1">
                                <div class="content-box">
                                    <p>Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. excepteur sint occaecat cupid atat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                                    <p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nescunt. neque porro quisquam est qui dolorem ipsum quia dolor sit amet consectetur adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                                </div>
                            </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 comment-column">
                                        <div class="customer-comments">
                                            ...
                                            <form action="https://azim.commonsupport.com/Acuasafe/single-shop-1.php" method="post" class="comment-form">
                                                <div class="row clearfix">
...
<!-- Mirrored from azim.commonsupport.com/Acuasafe/shop-details.php by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Feb 2024 07:30:04 GMT -->
</html>
